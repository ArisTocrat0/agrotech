...
const translations = {
  ...
  "Анализ выполняется. При первом запуске загружается модель — это может занять несколько минут. Результаты появятся автоматически. Вы можете переходить между вкладками.": {
    "en": "Analysis is running. The model downloads on the first run, which may take a few minutes. Results will appear automatically. You can switch between tabs.",
    "kk": "Талдау орындалуда. Алғашқы іске қосу кезінде модель жүктеледі — бұл бірнеше минут алуы мүмкін. Нәтижелер автоматты түрде көрсетіледі. Қойындылар арасында ауыса аласыз."
  },
